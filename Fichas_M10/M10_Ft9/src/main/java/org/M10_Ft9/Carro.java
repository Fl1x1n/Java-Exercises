...
public class Carro implements Buzina {
    public void buzinar() {
    }
    ...
    public static class Carro1 {
        ...
        */
        // Visto que carro é uma Classe Principal, não podemos dar override no método original ou usar o método da interface buzina
    }
}
